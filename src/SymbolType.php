...
abstract class SymbolType
{
    ...
    public const NT_BEGIN_OBJECT = 0x23;
    public const NT_OBJECT_MEMBERS = 0x24;
    public const NT_OBJECT_MEMBER = 0x25;
    public const NT_END_OBJECT = 0x26;
    public const NT_NEXT_OBJECT_MEMBERS = 0x27;
    public const NT_NAME_SEPARATOR = 0x28;
    public const NT_VALUE_SEPARATOR = 0x29;
    public const NT_BEGIN_ARRAY = 0x2A;
    public const NT_ARRAY_VALUES = 0x2B;
    public const NT_END_ARRAY = 0x2C;
    public const NT_NEXT_ARRAY_VALUES = 0x2D;
    public const NT_UNSIGNED_NUMBER = 0x2E;
    public const NT_INT = 0x2F;
    public const NT_INT_TAIL = 0x30;
    public const NT_FRAC = 0x31;
    public const NT_OPT_EXP = 0x32;
    public const NT_DIGIT = 0x33;
    public const NT_OPT_SIGN = 0x34;
    public const NT_OPT_DIGIT = 0x35;
